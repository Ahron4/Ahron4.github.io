...
layout: project
type: project
image: img/GUI-tempConverter/GUI-tempConverterCover.png
...
labels:
  ...
  - Tkinter
  - GUI
summary: "A simple GUI temperature converter using Python tkinter."
---

<div class="text-center p-4">
  <img width="400px" src="../img/GUI-tempConverter/GUI-tempConverter1.png" class="img-thumbnail" >
  <img width="400px" src="../img/GUI-tempConverter/GUI-tempConverter2.png" class="img-thumbnail" >
</div>

This small project took me all the way back in high school, where our task was to design a simple GUI using Python tkinter. I decided to implement a GUI temperature converter where users can go between pages and adjust the bar to their desired temperature. I tried to implement an input field where, instead of a horizontal bar, users could just input their temperature to be converted. Unfortunately, during that time, I was unable to handle edge cases of user input, such as when the user types -999999999 or if the user enters a string. A few years later, I am now in college, and I learned a lot in terms of computer science, in which I am confident, going back and fixing the issues as well as perhaps updating the code to be more visually appealing to the user as well as maybe including a Kelvin temperature as well.

Here is the code that illustrates my thought process during my junior year of high school:
